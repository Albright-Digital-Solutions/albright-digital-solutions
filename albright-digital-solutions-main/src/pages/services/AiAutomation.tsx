...
const faqs = [
  ...
  { question: 'Is AI automation right for small businesses in Texas?', answer: 'Absolutely. AI automation allows small businesses to deliver enterprise-level customer experiences without a large support team. Businesses across Austin, Round Rock, Cedar Park, and Georgetown use our AI agents to automate support, booking, follow-ups, and data entry.' },
];
...
export default function AiAutomation() {
  const schemas = [
    serviceSchema(SERVICE_NAME, 'Custom AI agents and workflow automation for businesses in Austin, Round Rock, Cedar Park, and Central Texas.', SERVICE_URL),
    faqSchema(faqs),
      ...
      <section className="relative px-4 py-20 sm:py-28 overflow-hidden border-b border-[var(--color-brand-border)]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-3xl leading-relaxed mb-8">
            Albright Digital Solutions deploys custom-built AI agents and intelligent automation systems for businesses in Austin, Round Rock, Cedar Park, Georgetown, and across Central Texas. Our autonomous agents handle customer support, lead qualification, appointment scheduling, and data processing — operating 24/7 so your team can focus on growth.
          </p>
      ...
      <section className="px-4 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            {[
              { icon: <MessageSquare size={28} />, title: 'Intelligent Customer Support Agents', text: 'We build AI-powered chat and voice agents that understand your customers\' questions and provide accurate, context-aware responses around the clock. Unlike generic chatbots, our agents are trained on your specific services, pricing, policies, and FAQs — delivering answers that feel personal. For businesses in Austin and the surrounding area, this means no more missed calls after hours and dramatically improved customer satisfaction.' },
              ...
              { icon: <Cpu size={28} />, title: 'Lead Qualification & Follow-Up Systems', text: 'Our AI-powered lead qualification systems engage prospects the moment they interact with your business, ask qualifying questions, score intent, and route hot leads to your sales team in real time. Cold leads enter automated nurture sequences. This approach consistently doubles close rates for our clients across Round Rock, Cedar Park, and the greater Austin metro.' },
              { icon: <BarChart3 size={28} />, title: 'Data Processing & Reporting Agents', text: 'Transform raw data into actionable business intelligence. Our AI agents automatically extract information from invoices, forms, emails, and spreadsheets — then compile clean dashboards and reports. Small business owners in Austin gain instant visibility into revenue trends, customer behavior, and operational metrics without hiring a data analyst.' },
            ].map((item) => (
